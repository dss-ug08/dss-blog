...
const securityHeaders = {
  ...
  'Content-Security-Policy': "default-src 'self' 'unsafe-inline'; img-src * 'self' data:; frame-src www.google.com; script-src www.google.com 'self';",  // Don't load content from other hosts (XSS protection)
